// Adapted from @sabaki/influence (MIT); see LICENSE and README.md.
import areaMap from './areaMap.js'
import nearestNeighborMap from './nearestNeighborMap.js'
import radianceMap from './radianceMap.js'
import {getNeighbors, average} from './helper.js'

export default function(data, {discrete = false, maxDistance = 6, minRadiance = 2} = {}) {
